...
int main(){
    ...
    //Creación ataques por nivel - Pokemones
    ...
    //Creación experiencia por nivel - Pokemones
    ...
    //Agregado de los Pokemones con su información al mapa Pokedex, cada uno serializa
